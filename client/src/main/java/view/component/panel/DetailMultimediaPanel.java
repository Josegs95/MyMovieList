...
public class DetailMultimediaPanel extends JPanel {
    ...
    private void createListeners() {
        ...
        btnAddToList.addActionListener(_ -> {
            ...
            if (response.status() != 200) {
                ...
                currentEpisode = (int) (response.content().get("currentEpisode"));
                status = MultimediaStatus.valueOf(response.content().get("status").toString());
    ...
    private void processServerError(Message response, String defaultMessage) {
