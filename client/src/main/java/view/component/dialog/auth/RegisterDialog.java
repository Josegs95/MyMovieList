    ...
    private void init(){
        ...
        btnRegister.addActionListener(_ -> {
            try{
                ...
                Message serverMessage = AuthenticationController.registerUser(userData);

                if (serverMessage != null && serverMessage.status() != 200) {
//                    String errorMessage = serverMessage.getErrorCode() == 23
